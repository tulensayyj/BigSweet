...
import com.graduation.yau.bigsweet.base.BaseApplication;
...
public class RequestBuilder {
    ...
    private static ConcurrentHashMap<HostType, RequestBuilder> sRetrofitManager = new ConcurrentHashMap<>();
    ...
    public enum HostType {
        GANK_BEAUTY_PHOTO, NETEASE_NEWS;
   ...
   1. noCache 不使用缓存，全部走网络
    ...
    private RequestBuilder(HostType hostType) {
        ...
        retrofit = new Retrofit.Builder()
                ...
                .baseUrl(RequestUrls.getHost(hostType))
                .build();
        movieService = retrofit.create(RequestService.class);
    }


    /**
     * @param hostType NETEASE_NEWS：1 （新闻，视频），GANK_GIRL_PHOTO：2（图片新闻）;
     *                 EWS_DETAIL_HTML_PHOTO:3新闻详情html图片)
     */
    public static RequestService getDefault(HostType hostType) {
        RequestBuilder retrofitManager = sRetrofitManager.get(hostType);
        if (retrofitManager == null) {
            retrofitManager = new RequestBuilder(hostType);
